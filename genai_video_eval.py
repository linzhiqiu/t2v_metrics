# Evaluate on GenAI-Bench-Video (with 527 prompt) using a specific model
...
def main():
    ...
    result_path = f"{args.result_dir}/{args.model}_{args.eval_mode}_527_prompts.pt"
    dataset = GenAIBench_Video(root_dir=args.root_dir, eval_mode=args.eval_mode)

...
# VQAScore: python genai_image_eval_1600.py --model clip-flant5-xxl
# CLIPScore: python genai_image_eval_1600.py --model openai:ViT-L-14-336
# GPT4o VQAScore: python genai_image_eval_1600.py --model gpt-4o
# python genai_image_eval_1600.py --model image-reward-v1
# python genai_image_eval_1600.py --model blip2-itm
# python genai_image_eval_1600.py --model hpsv2
# python genai_image_eval_1600.py --model pickscore-v1
import argparse
import os
import t2v_metrics
from dataset import GenAIBench_Image, GenAI_Bench_Image_1600
import json
import torch
import numpy as np
...
def main():
    ...
    dataset = GenAI_Bench_Image_1600(root_dir=args.root_dir)
    ...
    if os.path.exists(result_path):
        ...
        for item in tqdm(dataset):
            images = item["images"]
            texts = item["texts"]
            score = score_func(images, texts).cpu()  
            scores.append(score)   

...
def main():
    ...
    parser.add_argument("--output", type=str, default="qwen2.5-vl-7b-1-3-6.json", help="Path to output JSON file")
    parser.add_argument("--sample-size", type=int, default=100, help="Number of items to sample")
    parser.add_argument("--models", type=str, nargs="+", default=['qwen2.5-vl-7b-1-3-6'], 
